...
export default function Hero() {
    ...
    return (
        <section className="bg-gray-900 relative h-screen w-screen flex flex-row flex-wrap justify-center items-center">
            <div className="w-3/4 xl:w-3/5 2xl:w-2/5 flex flex-row flex-wrap justify-between items-center">
                <div className="m-4 flex flex-col items-start">
                    <h1 className="font-bold text-4xl">Simon</h1>
                ...
                <div className="flex flex-col items-start rounded p-2 gap-2 m-4">
